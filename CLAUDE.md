...
| 2 | `G:\My Drive\עבודה עסקים\ALICESCOOL\wabsite\` | **גיבוי ב-Google Drive** – סנכרון אוטומטי (כנראה דרך Drive Desktop) |
| 3 | https://github.com/PsyMall/alicecool-app | **GitHub + GitHub Pages** (האתר החי) |

**אימות אחרון (2026-04-10):** גודל הקבצים זהה בדיוק בין התיקייה הראשית לגוגל דרייב (CLAUDE.md 22,323 בייט, index.html 99,014 בייט וכו') → הגיבוי מסונכרן ומעודכן.

**תרחישי חירום:**
- **GitHub נפל/נחסם:** לקחת את הקבצים מגוגל דרייב או מהמחשב ולהעלות ל-Netlify / Cloudflare Pages / Vercel (15 דקות)
- **המחשב נדפק:** להוריד מגוגל דרייב או מ-GitHub
- **אובדן גישה לגוגל דרייב:** עדיין יש GitHub + המחשב
- **אובדן כל השלושה בבת אחת:** תרחיש בלתי סביר – אבל אפשר להוסיף שכבה רביעית (GitLab mirror או Dropbox)

**המלצה:** אחרי כל שיחת עבודה – לוודא שגוגל דרייב סיים לסנכרן (האייקון הירוק על הקבצים) לפני סגירת המחשב.
